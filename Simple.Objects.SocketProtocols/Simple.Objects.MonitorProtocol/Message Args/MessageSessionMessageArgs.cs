...
{
	[SystemMessageArgs((int)MonitorSystemMessage.MessageSent)]
	[SystemMessageArgs((int)MonitorSystemMessage.MessageReceived)]

	public class MessageSessionMessageArgs : SessionMessageArgs
	{
        public MessageSessionMessageArgs()
        {
        }

        public MessageSessionMessageArgs(long sessionKey, byte[] messageBuffer)
            : base(sessionKey)
        {
