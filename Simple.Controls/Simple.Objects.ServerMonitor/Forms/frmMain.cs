...
namespace Simple.Objects.ServerMonitor
{
	public partial class frmMain : RibbonForm
	{
		...
		{
			if (this.skinPaletteRibbonGalleryBarItem1 != null)
				this.skinPaletteRibbonGalleryBarItem1.Enabled = !this.AppContext.UserSettings.DarkMode;
			
			if (this.skinPaletteRibbonGalleryBarItem2 != null)
				this.skinPaletteRibbonGalleryBarItem2.Enabled = !this.AppContext.UserSettings.DarkMode;
		}
		...
		{
			if (this.ribbonControl.GetController().LookAndFeel.ActiveSkinName != "Office 2016 Colorful")
		...
		{
			pc = new PopupColor2(container, this);
		}
			...
			if (response.ResponseSucceeded && response.SessionInfos != null)
			{
				for (long i = 0; i < response.SessionInfos.LongLength; i++)
				{
					...
					SessionInfoRow sessionInfoRow = new SessionInfoRow((int)i, sessionInfo.SessionKey, sessionInfo.ServerAddress, sessionInfo.ServerPort, sessionInfo.ClientAddress, sessionInfo.ClientPort,
																	   sessionInfo.UserId, sessionInfo.Username, connected: true, sessionInfo.CharacterEncoding, context: null);
		...
		private void AppClient_OnSessionConnected(SessionConnectedMessageArgs e)
		{
			...
			SessionInfoRow row = new SessionInfoRow(rowIndex, e.SessionKey, e.ServerAddress!, e.ServerPort, e.ClientAddress!, e.ClientPort,
													userId: 0, username: String.Empty, connected: true, e.CharacterEncoding, context: null);
