...
{
	public abstract class ObjectModelInfoBase : ModelElement
	{
		private HashSet<int> propertyModelIndexes = new HashSet<int>();

		public ObjectModelInfoBase()
		{
		}

		public ObjectModelInfoBase(TableInfo tableInfo)
		{
			this.TableInfo = tableInfo;
		}

		public ObjectModelInfoBase(string objectName, TableInfo tableInfo)
			: this(tableInfo)
		{
