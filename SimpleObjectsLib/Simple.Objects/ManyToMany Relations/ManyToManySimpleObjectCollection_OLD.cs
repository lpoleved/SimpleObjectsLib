...
//{
//    public class ManyToManySimpleObjectCollection<T> : SimpleObjectCollection_OLD<T>, IList<T>, ICollection<T>, IEnumerable<T>, ISimpleObjectCollection_OLD, IManyToManyCollectionControl, IList, ICollection, IEnumerable 
...
//        public ManyToManySimpleObjectCollection(SimpleObject owner, ManyToManyRelation manayToManyRelation, IList<GroupMembershipElement> manyToManyRelationElements, bool isOwnerObjectIdFirst)
//            : base(owner.Manager)
//        {
//            this.owner = owner;
...
//            foreach (GroupMembershipElement manyToManyRelationElement in this.ManyToManyRelationElements)
//            {
...
//                this.InnerList.Add(relatedSimpleObject);
//            }
//        }

//        internal ManyToManySimpleObjectCollection(SimpleObject owner, ManyToManyRelation manayToManyRelation, IList<GroupMembershipElement> manyToManyRelationElements, IList<T> innerListToWrap, bool isOwnerObjectIdFirst)
...
//            lock (this.lockObject)
//            {
//                this.InnerList.Remove(simpleObject as T);
//            }
//        }
...
//        {
//            this.OnBeforeRemove(index, oldValue);
...
//        {
//            SimpleObject simpleObject1 = (this.isOwnerObjectIdFirst) ? this.owner : value;
//            SimpleObject simpleObject2 = (this.isOwnerObjectIdFirst) ? value : this.owner;
//            ChangeContainer changeContainer = this.owner.ChangeContainer ?? this.owner.Manager.DefaultChangeContainer;

//            GroupMembershipElement manyToManyRelationElement = new GroupMembershipElement(this.owner.Manager, this.manayToManyRelation.RelationKey, this.manayToManyRelation, simpleObject1, simpleObject2, changeContainer);
...
//            //T simpleObject = this[index];
//            value.AddToManyToManyObjectCollectionIfInCache(manyToManyRelationElement);
...
//    internal interface IManyToManyCollectionControl
//    {
