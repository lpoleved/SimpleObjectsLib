...
namespace Simple.Objects.ServerMonitor
{
	partial class FormMain
	{
		...
		private void InitializeComponent()
		{
			...
			iWeb.Hint = "Simple.Objects™ on the Web";
			iWeb.Id = 21;
			...
			barButtonItem3.Caption = "Powered by Simple.Objects™";
			...
			// 
			recentLabelItemAppNameAndVersion.Caption = "Simple.Objects™ Server Monitor, Version 1.0.0";
			...
			// 
			recentHyperlinkItem4.Caption = "Powered by Simple.Objects™ project on GitHub";
			...
			recentLabelItemCopyrigjht.Caption = "Copyright © 2025 by Simple.Objects™. All Rights Reserved.";
			...
			recentPinItem2.Description = "Get help using Simple.Objects™ app framework";
