...
namespace Simple.Objects.ServerMonitor
{
	...
	/// </summary>
	public partial class FormPad : DevExpress.XtraEditors.XtraForm
	{
		public FormPad()
		{
			//
			...
			//
			InitializeComponent();
			Icon = DevExpress.Utils.ResourceImageHelper.CreateIconFromResourcesEx("Simple.Objects.ServerMonitor.AppIcon.ico", typeof(FormMain_OLD).Assembly);
			//
		...
		public bool Modified
		{
			...
			set
			{
				if (value != modifiedCore)
				{
					...
					if (MdiParent != null)
						((FormMain_OLD)MdiParent).UpdateText();
				}
			}
		}
