...
namespace Simple.Objects.ServerMonitor
{
	...
	public partial class EditPanelTransactionCompleted : EditPanelSessionPackageMessage
	{
		private GridColumn columnIndex, columnAction, columnTableId, columnObjectId, columnPropertyValues;
		private BindingList<TransactionActionRow> dataSourceTransactionRequestDetails = new BindingList<TransactionActionRow>();
		RepositoryItemMemoEdit repositoryItemPropertyValues = new RepositoryItemMemoEdit();

		public EditPanelTransactionCompleted()
		{
			InitializeComponent();

			this.columnIndex = new GridColumn();
			this.columnIndex.Name = this.columnIndex.FieldName = this.columnIndex.Caption = "Index";
			this.columnIndex.OptionsColumn.AllowSort = DevExpress.Utils.DefaultBoolean.False;
			this.columnIndex.OptionsFilter.AllowFilter = false;
			...
			this.gridViewTransactionDetails.Columns.Add(this.columnIndex);
			...
			this.gridViewTransactionDetails.Columns.Add(this.columnAction);
			...
			this.gridViewTransactionDetails.Columns.Add(this.columnTableId);
			...
			this.gridViewTransactionDetails.Columns.Add(this.columnObjectId);
			...
			this.gridViewTransactionDetails.Columns.Add(this.columnPropertyValues);
			this.gridControlTransactionDetails.RepositoryItems.Add(this.repositoryItemPropertyValues);

			this.gridViewTransactionDetails.OptionsBehavior.AutoPopulateColumns = false;
			this.gridViewTransactionDetails.OptionsView.ShowGroupPanel = false;
			this.gridViewTransactionDetails.OptionsView.ColumnAutoWidth = true;
			this.gridViewTransactionDetails.OptionsView.RowAutoHeight = true;
			GridHelper.SetViewOnlyMode(this.gridViewTransactionDetails);
		...
		protected override MessageArgs? CreateMessageArgs() => new TransactionCompletedMessageArgs();
		...
		private void AppendTransactionRequestActionRow(int actionNumber, TransactionActionInfo transactionActionWithDataInfo)
		{
			...
			TransactionActionRow row = new TransactionActionRow(actionNumber, action, tableIdText, transactionActionWithDataInfo.ObjectId.ToString(), transactionActionInfo);
			//int rowIndex = this.dataSourceTransactionRequestDetails.Count;
		...
		{
			public TransactionActionRow(int index, string actionText, string tableIdText, string objectId, string propertyValuesText)
			{
				this.Index = index;
