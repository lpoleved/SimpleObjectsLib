...
{
	partial class EditPanelTransactionCompleted
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			gridControlTransactionDetails = new DevExpress.XtraGrid.GridControl();
			gridViewTransactionDetails = new DevExpress.XtraGrid.Views.Grid.GridView();
			labelControlTransactionActions = new DevExpress.XtraEditors.LabelControl();
			...
			((System.ComponentModel.ISupportInitialize)gridControlTransactionDetails).BeginInit();
			((System.ComponentModel.ISupportInitialize)gridViewTransactionDetails).BeginInit();
			SuspendLayout();
			// 
			// tabControlMessage
			// 
			...
			editorMessagePackageValue.Size = new Size(603, 412);
			// 
			...
			// 
			// gridViewTransactionDetails
			// 
			gridViewTransactionDetails.GridControl = gridControlTransactionDetails;
			gridViewTransactionDetails.Name = "gridViewTransactionDetails";
			// 
			...
			labelControlTransactionActions.Text = "Transaction Actions";
			// 
			// EditPanelTransactionCompleted
			// 
			...
			((System.ComponentModel.ISupportInitialize)gridControlTransactionDetails).EndInit();
			((System.ComponentModel.ISupportInitialize)gridViewTransactionDetails).EndInit();
			ResumeLayout(false);
		}
		...
		private DevExpress.XtraGrid.GridControl gridControlTransactionDetails;
		private DevExpress.XtraGrid.Views.Grid.GridView gridViewTransactionDetails;
		private DevExpress.XtraEditors.LabelControl labelControlTransactionActions;
	}
}
