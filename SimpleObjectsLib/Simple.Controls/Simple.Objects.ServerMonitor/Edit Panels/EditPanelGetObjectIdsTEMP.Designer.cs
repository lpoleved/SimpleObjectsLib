...
{
	partial class EditPanelRequestGetObjectIdsTEMP
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			// 
			tabControlRequestResponse.Size = new Size(574, 535);
			// 
			// tabPageRequest
			// 
			tabPageRequest.Size = new Size(572, 510);
			// 
			// tabPageResponse
			// 
			tabPageResponse.Size = new Size(572, 510);
			// 
			...
			packageHeaderControlResponse.Size = new Size(362, 79);
			// 
			...
			// tabControlResponse
			// 
			tabControlResponse.Size = new Size(566, 441);
			// 
			// tabPageResponseDetails
			// 
			tabPageResponseDetails.Controls.Add(treeListObjectIds);
			tabPageResponseDetails.Size = new Size(564, 416);
			// 
			// tabPageResponsePackageBinaries
			// 
			tabPageResponsePackageBinaries.Size = new Size(585, 416);
			// 
			// tabControlRequest
			// 
			tabControlRequest.Size = new Size(566, 441);
			// 
			...
			tabPageRequestDetails.Size = new Size(564, 416);
			// 
			// tabPageRequestPackageBinaries
			// 
			tabPageRequestPackageBinaries.Size = new Size(585, 416);
			// 
			...
			editorTableId.Size = new Size(500, 20);
			...
			treeListObjectIds.Size = new Size(558, 407);
			treeListObjectIds.TabIndex = 4;
			// 
			// EditPanelRequestGetObjectIds
			// 
			AutoScaleDimensions = new SizeF(6F, 13F);
			AutoScaleMode = AutoScaleMode.Font;
			Name = "EditPanelRequestGetObjectIds";
