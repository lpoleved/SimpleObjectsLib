...
{
	partial class SystemEditPanelWithTabControl
	{
		///// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.tabControl.TabPages.AddRange(new DevExpress.XtraTab.XtraTabPage[] { this.tabPageObjectName });
			// 
			// tabPageObjectName
			// 
			...
			// 
			// SystemEditPanelWithTabControl
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.Controls.Add(this.tabControl);
			this.Name = "SystemEditPanelWithTabControl";
