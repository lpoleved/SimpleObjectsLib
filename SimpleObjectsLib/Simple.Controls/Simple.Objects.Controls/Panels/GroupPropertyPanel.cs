...
namespace Simple.Objects.Controls
{
	public partial class GroupPropertyPanel : UserControl
	{
		...
		private Dictionary<Type, UserControl> editPanelsByBindingObjectType = new Dictionary<Type, UserControl>();
		private Dictionary<Type, UserControl> editPanelsByType = new Dictionary<Type, UserControl>();
		private Dictionary<Type, Type> editPanelTypeDefinitionsByBindingObjectType = new Dictionary<Type, Type>();
		private UserControl? activePropertyPanel = null;
