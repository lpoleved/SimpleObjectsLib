...
{
	[SystemRequestArgs((int)SystemRequest.DoesGraphElementHaveChildren)]

	public class ObjectIdRequestArgs : RequestArgs
	{
		public ObjectIdRequestArgs()
		{
		}

		public ObjectIdRequestArgs(long objectId)
		{
