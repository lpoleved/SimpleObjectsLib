...
{
	partial class EditPanelServerMonitorBase
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			// tabControl
			// 
			tabControl.Size = new Size(578, 628);
			// 
			// tabPageObjectName
			// 
			...
			tabPageObjectName.Size = new Size(576, 603);
			tabPageObjectName.Text = "Socket Package Event";
			// 
			// editorUser
			// 
