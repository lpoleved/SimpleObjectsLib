...
namespace Simple.Objects.ServerMonitor
{
	...
	public partial class EditPaneGetAllServerObjectModels : EditPanelSessionPackageRequestResponse
	{
		...
		public EditPaneGetAllServerObjectModels()
		{
			InitializeComponent();
		...
		protected override void OnRefreshBindingObject()
		{
			...
			AllServerObjectModelsResponseArgs? responseArgs = this.PackageInfoRow?.ResponsePackageInfo?.PackageArgs as AllServerObjectModelsResponseArgs;
		...
		protected override ResponseArgs CreateResponseArgs() => new AllServerObjectModelsResponseArgs();
