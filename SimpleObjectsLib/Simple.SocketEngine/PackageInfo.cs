...
namespace Simple.SocketEngine
{
	public class PackageInfo : IKeyedPackageInfo<int>
	{
		...
		public PackageInfo(byte[] buffer, int start = 0) //, Encoder characterEncoder)
		{
			this.Buffer = buffer;
			this.position = start;
			//this.start = start;
		...
		public int PackageLengthSize { get; private set; }
		...
		public void ReadPackageLength()
		{
			...
			this.PackageLengthSize = this.BytesConsumed;
		}
		...
		public void ReadHeader()
		{
			...
			this.HeaderSize = this.BytesConsumed - this.PackageLengthSize;
		}
