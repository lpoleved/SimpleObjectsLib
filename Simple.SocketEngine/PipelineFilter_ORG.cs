...
//	public class PipelineFilter_ORG : IPipelineFilter<PackageReader_OLD>, IPipelineFilter
//	{
//		private PackageArgsFactory packageArgsFactory;
//		private Encoding characterEncoding = new UTF8Encoding();
//		private PackageReader_OLD packageInfo;
//		private bool createPackageDataCopy;

//		// Constructor that requires dependency injection
//		public PipelineFilter_ORG(PackageArgsFactory packageArgsFactory, bool createPackageDataCopy)
//        {
//			this.packageArgsFactory = packageArgsFactory;
//			this.packageInfo = new PackageReader_OLD(this.packageArgsFactory);
//			this.createPackageDataCopy = createPackageDataCopy;
//        }

//        public PackageReader_OLD Filter(ref SequenceReader<byte> reader)
//		{
//			if (!this.packageInfo.IsPackageLengthInfoReceived(ref reader))
//				return default!; // Package length is not fully received yet...

//			if (reader.Length < (this.packageInfo.PackageLength)) // if (reader.Length < this.packageInfo.TotalPackageLength)
//				return default!; // Haven't received a full package -> there is more data...

//			if (this.packageInfo.TotalPackageLength != reader.Length)
//				reader = reader;
...
//		public IPipelineFilter<PackageReader_OLD> NextFilter => null!;
...
//		public void Reset()
//		{
//			this.packageInfo = new PackageReader_OLD(this.packageArgsFactory, this.createPackageDataCopy);
//		}

//		//public IPackageDecoder<PackageReader>? Decoder { get => this.packageInfo; set { } }
//		public IPackageDecoder<PackageReader_OLD>? Decoder { get => this.packageInfo; set { } }
//	}
//}
