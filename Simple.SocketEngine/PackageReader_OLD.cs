...
//{
//	public class PackageReader_OLD : IPackageDecoder<PackageReader_OLD>, IKeyedPackageInfo<int>
//	{
...
//		public PackageReader_OLD(PackageArgsFactory packageArgsFactory, bool createDataCopy = false)
//        {
...
//		internal bool IsPackageLengthInfoReceived(ref SequenceReader<byte> reader)
//		{
//			if (!this.packageLengthReceived)
//			{
//				this.packageLengthReceived = TryGetInt64By7BitEncoding(ref reader, ref this.packageDataLength, ref this.packageLengthInfoSize);

//				if (this.packageLengthReceived)
//					this.totalPackageLength = this.packageDataLength + this.packageLengthInfoSize;
//			}
...
//		public PackageReader_OLD Decode(ref ReadOnlySequence<byte> sequence, object context)
//		{
...
//		public PackageReader_OLD Decode(ref SequenceReader<byte> buffer, ISimpleSession? session)
//		{
...
//		public PackageReader_OLD DecodeOld(ref SequenceReader<byte> buffer, object context)
//		{
//			if (this.createDataCopy)
//				this.Buffer = buffer.Sequence.ToArray();
...
//				reader.AdvancePosition(this.PackageLengthInfoSize); // Skip reading package data length again
