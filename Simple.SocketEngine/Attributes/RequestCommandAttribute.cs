...
namespace Simple.SocketEngine
{
    ...
    public sealed class RequestCommandAttribute : Attribute
    {
		/// <summary>
		...
		public RequestCommandAttribute(int requestId)
		...
		/// <param name="requestId">The unique request identifier.</param>
		public RequestCommandAttribute(int requestId, string name)
        {
            this.Name = name;
