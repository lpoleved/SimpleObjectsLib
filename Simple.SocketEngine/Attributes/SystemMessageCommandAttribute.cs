...
namespace Simple.SocketEngine
{
    ...
    public sealed class SystemMessageCommandAttribute : Attribute
    {
		/// <summary>
		...
		public SystemMessageCommandAttribute(int messageCode)
		...
		/// <param name="messageCode">The unique message code identifier.</param>
		public SystemMessageCommandAttribute(int messageCode, string name)
        {
            this.Name = name;
